...
| **B14** | 🔄 **Vai-e-vem** — se A→B é longe e A→C é perto, **B é erro**. *(Estava marcada como "B8" no `MAPA_DAS_REGRAS.md` — **colisão de nomes** com a B8 real. Renumerada.)* | ✅ implementada | `gerar_tempo_util.vai_e_vem()` |
